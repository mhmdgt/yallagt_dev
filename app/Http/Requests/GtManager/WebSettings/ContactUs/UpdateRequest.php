...
namespace App\Http\Requests\GtManager\WebSettings\ContactUs;
...
class UpdateRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'whatsapp.url' => 'The Whatsapp URL format is invalid.',
            'google_maps.url' => 'The Google Maps URL format is invalid.',
        ];
    }
}
