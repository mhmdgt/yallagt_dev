...
class CheckoutController extends Controller
{
    public function index()
    {
        ...
        }, 'UserCartItems.productSku', 'UserCartItems.productListing.seller'])->whereUserId(auth()->id())->first();
        ...
        return view('yalla-gt.pages.cart.checkout',
            compact('address', 'governorates', 'paymentMethods', 'shippingServices', 'cart', 'totalQty', 'subtotal'
            ));
    }
    // -------------------- Method -------------------- //
