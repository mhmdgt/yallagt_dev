(function ($) {
    ...
    if ($slider.length > 0) {
        $slider.owlCarousel({
            ...
            loop: true,
            nav: true,
            navText: ["<img src='/yalla_gt/public//front/img/icon/left-arrow.png'>", "<img src='/yalla_gt/public//front/img/icon/right-arrow.png'>"],
            autoplay: false,
    ...
    var $detailedSearch__content__dropdowns = $('.detailedSearch__content--dropdowns');
    if ($detailedSearch__content__dropdowns.length > 0) {
        $detailedSearch__content__dropdowns.on('changed.owl.carousel initialized.owl.carousel', function (event) {
            $(event.target).find('.owl-item').removeClass('last').eq(event.item.index + event.page.size - 1).addClass('last')
        }).owlCarousel({
            autoplay: false,
            items: 6,
    ...
    /*--- ==================================== Product page column4 activation ==================================== ---*/
    ...
    var $card_breaks_carousel = $('.vertical_shop_carousel');
    ...
    if ($form_check_slider.length > 0) {
        $form_check_slider.slick({
            ...
            slidesToScroll: 1,
            arrows: true,
            prevArrow: '<button class="slick-arrow slick-prev" type="button"><img src="/front/img/icon/up.png"></button>',
            nextArrow: '<button class="slick-arrow slick-next" type="button"><img src="/front/img/icon/down.jpg"></button>'
        });
    }
    var $vertical_shop_slider = $('.vertical_shop_slider');
    if ($vertical_shop_slider.length > 0) {
        $vertical_shop_slider.slick({
            vertical: true,
            verticalSwiping: true,
            slidesToShow: 4,
            slidesToScroll: 1,
    ...
    /*--- ====================================  specification NAV Active activation ==================================== ---*/
...
// Get the login button and login modal
...
// When the user clicks the login button, display the modal
if (loginBtn) {
