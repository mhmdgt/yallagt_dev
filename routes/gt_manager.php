...
Route::middleware('admin')->group(function () {
    ...
    // Stock Cars Categories //
    Route::controller(StockCarCategoryController::class)->prefix('stock-car-categories')->name('stock-car-categories.')->group(function () {
        Route::get('/create/{stock_car_id}', 'create')->name('create');
        Route::post('/','store')->name( 'store');
        Route::get('/{stockCarCategory}', 'edit')->name('edit');
