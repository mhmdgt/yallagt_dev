                            ...
                            <nav>
                                <ul class="align-items-center">
                                    ...
                                    <li>
                                        ...
                                        <ul class="sub_menu home_sub_menu d-flex"><!--  -->
                                            <li><span>Filters Types</span>
                                                <ul>
                                                    <li><a href="#">Oil Filters</a></li>
                                                    <li><a href="#">Air Filters</a></li>
                                                    <li><a href="#">A/C Filters</a></li>
                            ...
                            <div class="carsforsaleContainer owl-carousel ">
                                ...
                                <div class="card cars_for_sale_home_layout" style="border-radius: 16px;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h5 class="mt-3">By Mohamed Ahmed</h5>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="d-flex contact_info">
                                        ...
                                        <div class="content">
                                            <p>Call us anytime</p>
                                            <a href="tel:+20 111-012-0316">0111-012-0316</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                ...
                                <ul>
                                    ...
                                    <li class="widget_sub_categories sub_categories4">
                                        ...
                                        <ul class="widget_dropdown_categories dropdown_categories4">
                                            <p><span>Address:</span>
                                                55 El-Hussein, Ad Doqi, Dokki, Giza Government, Egypt</p>
                                            <p><span>Email:</span>
                                                <a href="mailto:sales@yourcompany.com">sales@yourcompany.com
                                                </a>
                                            </p>
                                            <p><span>Tel:</span>
                                                <a href="tel:0111-012-0316">0111-012-0316</a>
                                            </p>
                                        </ul>
                                    </li>
                                </ul>
                        ...
                        <div class="row footer_top--text">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-8">
                                ...
                                <div class="widgets_container contact_us">
                                    <p><span>Address:</span> My Company, 42 Puffin street 12345 Puffinville, Egypt</p>
                                    <p><span>Email:</span> <a href="mailto:sales@yourcompany.com">sales@yourcompany.com
                                        </a></p>
                                    <p><span>Tel:</span> <a href="tel:0111-012-0316">0111-012-0316</a> </p>
                                </div>
                            </div>
                        </div>

                        <!-- Coming soon & Social Media -->
                        <div class="pt-4 row justify-content-between align-items-end">
                            <div class="col-lg-6">
                                <div class="footer_widgets--content">
                                    <p>Coming soon on</p>
                                    <div
                                        class="row align-items-center justify-content-between footer_widgets--content-row">
                                        <div class="col-lg-7">
