        ...
        <nav class="page-breadcrumb">
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a>Engine Aspirations</a></li>
                </ol>
            </div>
        </nav>
        {{-- ====== Spec Details ====== --}}
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="col-12 d-flex align-items-center">
                            <span class="h4">Engine Aspirations</span>
                            <td>
            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        {{-- Loop Starts --}}
                                        @foreach ($AspirationTypes as $type)
                        ...
                        {{ $AspirationTypes->links('pagination::bootstrap-5') }}
                    </div>
                </div>
            </div>
        </div>
