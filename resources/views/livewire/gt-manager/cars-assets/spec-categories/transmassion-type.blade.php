<div>
    <div>
                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a
                                href="{{ route('spec-categories.index') }}">Specs
                                Categories</a></li>
                        <li class="breadcrumb-item"><a>Transmassion Type</a></li>
                    </ol>
                </div>
            </nav>
            {{-- ====== Spec Details ====== --}}
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="col-12 d-flex align-items-center">
                                <span class="h4">Transmassion Type</span>
                                <td>
        ...
        {{-- ========================== Add body Shapes ========================== --}}
        <x-modal.create title="transmassion type">
            <div class="form-group">
