                            ...
                            <div class="row">
                                @foreach ($brands as $brand)
                                    <div class="col-xl-2 col-lg-3 col-md-4 col-6 mb-4">
                                        <a href="{{ route('car-brand.show', $brand->slug) }}">
                                            <div class="border border-light rounded shadow-sm">
                                                <div class="card-logo ">
                                                    <img width="100px"
                                                        src="{{ !empty($brand->logo) ? asset('storage/' . $brand->logo) : asset('gt_manager/media/no_image.jpg') }}"
                                                        alt="No_IMG">
                                                </div>
                                            </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('car-brand.store') }}" method="POST" enctype="multipart/form-data"
                            id="car-brand">
                            @csrf
                            ...
                            <div class="modal-footer">
                                <button type="submit" id="add_employee_btn" class="btn btn-success">Save changes</button>
