        ...
        <nav class="page-breadcrumb">
            <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('car-brand.index') }}">Car Brands</a></li>
                    ...
                    <div class="card-body">
                        <div class="col-12 d-flex align-items-center">
                            <img class="image-in-box"
                                src="{{ !empty('') ? url('gt_manager/media/product_categories/' . $carBrand->logo ) : asset('gt_manager/media/no_image.jpg') }}"
                                alt="No Image">
