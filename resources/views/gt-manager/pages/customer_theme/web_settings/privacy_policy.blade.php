        ...
        <nav class="page-breadcrumb">
            <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a>Privecy Policy</a></li>
                </ol>
            </div>
        </nav>
        {{-- ====== Content ====== --}}
        <Form action="{{ route('web-settigns.privacyUpdate') }}" method="POST">
            @csrf
            {{-- Contact Details --}}
            <div class="row">
                            ...
                            <div class="form-group row pt-0">
                                <div class="col">
                                    ...
                                    <textarea class="form-control" name="content_en" id="tinymceExample" rows="10">
                                        {{ $privacy->getTranslations('content')['en'] }}
                                    </textarea>
                            ...
                            <div class="form-group row pt-0">
                                <div class="col">
                                    ...
                                    <textarea class="form-control" name="content_ar" id="tinymceExample2" rows="10">
                                        {{ $privacy->getTranslations('content')['ar'] }}
                                    </textarea>
