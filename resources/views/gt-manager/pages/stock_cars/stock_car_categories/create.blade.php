...
<div class="page-content">
    ...
    <form action="{{ route('stock-car-categories.store') }}" method="POST">
        @csrf
                        ...
                        <div class="form-group row pt-0 mt-4">
                            <div class="col">
                                ...
                                <select class="js-example-basic-single w-100" id="body_shape" name="body_shape_id">
                                    ...
                                    <option value="{{ $bodyShape->id }}" @selected(old('body_shape_id') == $bodyShape->id)>{{ $bodyShape->name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col">
                                ...
                                <div>
                                    <select class="js-example-basic-single w-100" name="engine_cc_id">
                                        ...
                                        <option value="{{  $engineCapacity->id }}" @selected(old('engine_cc_id') == $engineCapacity->id)>{{ $engineCapacity->name }}</option>
                                        @endforeach
                            ...
                            <div class="col">
                                ...
                                <div>
                                    <select class="js-example-basic-single w-100" name="engine_aspiration_id">
                                        ...
                                        <option value="{{  $enginAspiration->id }}" @selected(old('engine_aspiration_id') == $enginAspiration->id)>{{ $enginAspiration->name }}
                                        </option>
                                        @endforeach
                        ...
                        <div class="form-group row pt-0">
                            ...
                            <div class="col">
                                ...
                                <input class="typeahead form-control" type="text" placeholder="Torque" id="newton_meter"
                                    name="newton_meter" value="{{ old('newton_meter') }}">
