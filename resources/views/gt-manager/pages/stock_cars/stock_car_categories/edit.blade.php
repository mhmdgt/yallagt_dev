        ...
        <nav class="page-breadcrumb">
            <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><a href="{{ route('stock-car.index') }}">Stock Car Brands</a></li>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row pt-0">
                                ...
                                <div class="col">
                                    ...
                                    <input class="typeahead form-control" type="text" placeholder="Torque"
