...
@section('content')
    <div class="page-content">
        ...
        {{-- ====== Content ====== --}}
        {{-- <Form action="" name="carForSale" id="carForSaleID" method="POST" class="dropzone" enctype="multipart/form-data"> --}}
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        {{-- <div>
                            ...
                            {{-- <div id="dropzoneDargArea" class="dz-default dz-message dropzoneDargArea" >
